    ...
    public class EurekaHydatos : IEurekaTracker
    {
        ...
        public static EurekaHydatos GetTracker()
        {
            List<EurekaFate> HydatosFate = new()
            {
                ...
                new(1418, 61, 827, 515,     "Duty-free", "King Goldemar", "Golde", new Vector2(28.0f, 23.0f), "Hydatos Wraith", new Vector2(28.0f, 23.0f), EurekaWeather.None, EurekaWeather.None, EurekaElement.Lightning, EurekaElement.Lightning, true),
