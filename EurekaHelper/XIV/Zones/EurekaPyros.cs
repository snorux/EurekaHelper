    ...
    public class EurekaPyros : IEurekaTracker
    {
        ...
        public static EurekaPyros GetTracker()
        {
            List<EurekaFate> PyrosFates = new()
            {
                ...
                new(1393, 43, 795, 484,     "Up and Batym", "Grand Duke Batym", "Batym", new Vector2(17.8f, 14.1f), "Dark Troubadour", EurekaWeather.None, EurekaWeather.None, EurekaElement.Earth, EurekaElement.Earth, true),
                new(1394, 44, 795, 484,     "Rondo Aetolus", "Aetolus", "Aetolus", new Vector2(10.1f, 14.2f), "Islandhander", EurekaWeather.None, EurekaWeather.None, EurekaElement.Lightning, EurekaElement.Wind, false),
                new(1395, 45, 795, 484,     "Scorchpion King", "Lesath", "Lesath", new Vector2(12.6f, 11.1f), "Bird Eater", EurekaWeather.None, EurekaWeather.None, EurekaElement.Fire, EurekaElement.Wind, false),
                ...
                new(1398, 48, 795, 484,     "Thirty Whacks", "Lamebrix Strikebocks", "Lamebrix", new Vector2(21.8f, 8.4f), "Illuminati Escapee", EurekaWeather.None, EurekaWeather.None, EurekaElement.Earth, EurekaElement.Lightning, false),
                new(1399, 49, 795, 484,     "Put Up Your Dux", "Dux", "Dux", new Vector2(27.4f, 8.9f), "Matanga Castaway", EurekaWeather.Thunder, EurekaWeather.None, EurekaElement.Lightning, EurekaElement.Fire, false),
