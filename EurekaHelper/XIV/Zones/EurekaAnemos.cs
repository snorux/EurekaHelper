    ...
    public class EurekaAnemos : IEurekaTracker
    {
        ...
        public static EurekaAnemos GetTracker()
        {
            List<EurekaFate> AnemosFates = new()
            {
                ...
                new(1328, 4, 732, 414,  "The Swarm Never Sets", "The Emperor of Anemos", "Emperor", new Vector2(17.1f, 22.2f), "Darner", EurekaWeather.None, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Wind, false),
                ...
                new(1345, 7, 732, 414,  "Disinherit the Wind", "Jahannam", "Jaha", new Vector2(19.1f, 19.6f), "Typhoon Sprite", EurekaWeather.None, EurekaWeather.Gales, EurekaElement.Wind, EurekaElement.Wind, false),
                ...
                new(1339, 11, 732, 414, "Short Serket 2", "Serket", "Serket", new Vector2(24.9f, 18.2f), "Khor Claw", EurekaWeather.None, EurekaWeather.None, EurekaElement.Earth, EurekaElement.Earth, false),
                new(1346, 12, 732, 414, "Don't Judge Me, Morbol", "Judgemental Julika", "Julika", new Vector2(21.9f, 14.5f), "Henbane", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                ...
                new(1340, 18, 732, 414, "I Amarok", "Amarok", "Amarok", new Vector2(7.7f, 17.9f), "Voidscale", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                new(1338, 19, 732, 414, "Drama Lamashtu", "Lamashtu", "Lamashtu", new Vector2(7.6f, 26.6f), "Val Specter", EurekaWeather.None, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Wind, true),
                new(1329, 20, 732, 414, "Wail in the Willows", "Pazuzu", "Paz", new Vector2(7.4f, 21.6f), "Shadow Wraith", EurekaWeather.Gales, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Fire, true)
            };
