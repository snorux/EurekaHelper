    ...
    public class EurekaAnemos : IEurekaTracker
    {
        ...
        public static EurekaAnemos GetTracker()
        {
            List<EurekaFate> AnemosFates = new()
            {
                ...
                new(1345, 7, 732, 414,  "Disinherit the Wind", "Jahannam", new Vector2(18.0f, 19.0f), "Typhoon Sprite", EurekaWeather.None, EurekaWeather.Gales, EurekaElement.Wind, EurekaElement.Wind, false),
                new(1334, 8, 732, 414,  "Prove Your Amemettle", "Amemet", new Vector2(15.0f, 16.0f), "Abraxas", EurekaWeather.None, EurekaWeather.None, EurekaElement.Fire, EurekaElement.Fire, false),
                new(1335, 9, 732, 414,  "Caym What May", "Caym", new Vector2(14.0f, 13.0f), "Stalker Ziz", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                new(1336, 10, 732, 414, "The Killing of a Sacred Bombardier", "Bombadeel", new Vector2(28.0f, 20.0f), "Traveling Gourmand", EurekaWeather.None, EurekaWeather.None, EurekaElement.Earth, EurekaElement.Earth, true),
                new(1339, 11, 732, 414, "Short Serket 2", "Serket", new Vector2(25.0f, 18.0f), "Khor Claw", EurekaWeather.None, EurekaWeather.None, EurekaElement.Earth, EurekaElement.Earth, false),
                new(1346, 12, 732, 414, "Don't Judge Me, Morbol", "Judgemental Julika", new Vector2(22.0f, 16.0f), "Henbane", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                new(1343, 13, 732, 414, "When You Ride Alone", "The White Rider", new Vector2(20.0f, 13.0f), "Duskfall Dullahan", EurekaWeather.None, EurekaWeather.None, EurekaElement.Lightning, EurekaElement.Lightning, true),
                new(1337, 14, 732, 414, "Sing, Muse", "Polyphemus", new Vector2(26.0f, 14.0f), "Monoeye", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                new(1342, 15, 732, 414, "Simurghasbord", "Simurgh's Strider", new Vector2(29.0f, 13.0f), "Old World Zu", EurekaWeather.None, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Fire, false),
                new(1341, 16, 732, 414, "To the Mat", "King Hazmat", new Vector2(35.0f, 18.0f), "Anemos Anala", EurekaWeather.None, EurekaWeather.None, EurekaElement.Fire, EurekaElement.Fire, false),
                new(1331, 17, 732, 414, "Wine and Honey", "Fafnir", new Vector2(36.0f, 22.0f), "Fossil Dragon", EurekaWeather.None, EurekaWeather.None, EurekaElement.Fire, EurekaElement.Fire, true),
                new(1340, 18, 732, 414, "I Amarok", "Amarok", new Vector2(8.0f, 18.0f), "Voidscale", EurekaWeather.None, EurekaWeather.None, EurekaElement.Ice, EurekaElement.Ice, false),
                new(1338, 19, 732, 414, "Drama Lamashtu", "Lamashtu", new Vector2(8.0f, 23.0f), "Val Specter", EurekaWeather.None, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Wind, true),
                new(1329, 20, 732, 414, "Wail in the Willows", "Pazuzu", new Vector2(7.0f, 22.0f), "Shadow Wraith", EurekaWeather.Gales, EurekaWeather.None, EurekaElement.Wind, EurekaElement.Fire, true)
            };
